        ...
        case 2:
            switch (event.key) {
                ...
                case "5":
                    fadeOut();
                    if (event.ctrlKey) {
                        var subprocess = spawn('C:\\Program Files (x86)\\AIMP\\AIMP.exe', ['A:\\Music\\NieR Gestalt & Replicant Original Soundtrack Vinyl (FLAC) [lilin]\\Keiichi Okabe - NieR Gestalt & Replicant Original Soundtrack Vinyl.aimppl4'], {
                            detached: true,
                            stdio: 'ignore'
                        });
                        subprocess.unref();
